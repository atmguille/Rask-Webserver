 ...
 * @return the socket's file descriptor or -1 if something went wrong
 */
 ...
 * @return the client's socket's file descriptor or -1 if something went wrong
 */
 ...
 * @return the number of bytes sent or -1 if something went wrong
 */
 ...
 * @return number of bytes received or -1 if something went wrong
 */
